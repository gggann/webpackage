...
@dblclick="Command(this)">{{v.administrator.product.physicsCategoryIds.lcateNm}}</span> >
<span @dblclick="Commandtext(v.administrator.product.physicsCategoryIds.mcateCd)"
@dblclick="Command(this)">{{v.administrator.product.physicsCategoryIds.mcateNm}}</span> >
<span @dblclick="Commandtext(v.administrator.product.physicsCategoryIds.scateCd)"
@dblclick="Command(this)">{{v.administrator.product.physicsCategoryIds.scateNm}}</span> >
<span @dblclick="Commandtext(v.administrator.product.physicsCategoryIds.dcateCd)"
@dblclick="Command(this)">{{v.administrator.product.physicsCategoryIds.dcateNm}}</span>
...
v-html="highlightData(v.administrator.product.brandKeyword)"></span>
<a :href='"https://front.wemakeprice.com/" + stype(v.link.type)+"/"+v.link.value' target="_blank"><img
class="card-img-top" :src=v.mediumImgUrl alt="Card image cap" :style="'opacity:'+v.administrator.product.productList.length"></a>
        ...
        <div id="정보1">
            ...
            <div id="카테고리">
                <span @dblclick="Commandtext(v.categoryInfo.lcateCode)"
                    @click="Command(this)">{{v.categoryInfo.lcateName}}</span> 
                <span @dblclick="Commandtext(v.categoryInfo.mcateCode)"
                    @click="Command(this)">{{v.categoryInfo.mcateName}}</span> 
            </div>
